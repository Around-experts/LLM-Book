...
(If you downloaded the code bundle from the Manning website, please consider visiting the official code repository on GitHub at [https://github.com/Around-experts/LLM-Book](https://github.com/Around-experts/LLM-Book).)
...
- Link to the official [source code repository](https://github.com/Around-experts/LLM-Book)
...
Alternatively, you can view this and other files on GitHub at [https://github.com/Around-experts/LLM-Book](https://github.com/Around-experts/LLM-Book).
...
@book{build-llms-from-scratch-book,
  author       = {Hieu Truong Cong (Brenton)},
  ...
  github       = {https://github.com/Around-experts/LLM-Book}
}
```
