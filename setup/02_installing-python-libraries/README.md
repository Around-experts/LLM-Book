...
I used the following libraries listed [here](https://github.com/Around-experts/LLM-Book/blob/main/requirements.txt) for this book. Newer versions of these libraries are likely compatible as well. However, if you experience any problems with the code, you can try these library versions as a fallback.
...
Any questions? Please feel free to reach out in the [Discussion Forum](https://github.com/Around-experts/LLM-Book/discussions).
